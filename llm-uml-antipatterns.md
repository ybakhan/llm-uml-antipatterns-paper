...
achieves a recall of 0.87 and a precision of 0.81, recovering the
majority of expected instances at the cost of some false positives. The
MCC of 0.55 confirms a moderate-to-strong positive correlation between
predictions and ground truth, despite the modest dataset size.
